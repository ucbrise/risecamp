...
class GroundClient:
    ...
    def get_le_version(self, lev_id):
        r = requests.get(self.address + '/versions/lineage_edges/' + str(lev_id))
    ...
    def get_node_adj_le(self, nv_id):
        r = requests.get(self.address + '/versions/nodes/adjacent/lineage/' + str(nv_id))
